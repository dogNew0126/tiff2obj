...
void TerraMesh::greedy_insert(double max_error)
{
    ...
    std::cout << "starting greedy insertion with raster width: " << w << ", height: " << h << std::endl;
    ...
    std::cout << "initialize the mesh with four corner points" << std::endl;
    ...
    while (!m_candidates.empty())
    {
        ...
        std::cout << "inserting point: (" << candidate.x << ", " << candidate.y << ", " << candidate.z << ")" << std::endl;
    ...
    std::cout << "finished greedy insertion" << std::endl;
